...
export const ACHIEVEMENTS = [
  ...
  { id: 'dist5000',   icon: '✵', name: '洲际旅人',   desc: '单局行驶 5000 m',           rarity: 'rare',   scope: 'run',   metric: 'dist',      target: 5000 },
  ...
  { id: 'combo30',    icon: '✦', name: '登峰造极',   desc: '单局连击达到 ×30',          rarity: 'rare',   scope: 'run',   metric: 'maxCombo',  target: 30, eager: true },
  { id: 'speed200',   icon: '⌁', name: '音速冲击',   desc: '极速达到 200 km/h',         rarity: 'common', scope: 'run',   metric: 'speedKmh',  target: 200 },
  { id: 'speed250',   icon: '✹', name: '极速领域',   desc: '极速达到 250 km/h',         rarity: 'rare',   scope: 'run',   metric: 'speedKmh',  target: 250 },
  { id: 'gate1',      icon: '⬡', name: '滑铲初体验', desc: '首次滑铲穿过悬挂闸门',       rarity: 'common', scope: 'run',   event: 'gateSlide',  target: 1 },
  { id: 'gate5',      icon: '◈', name: '闸门舞者',   desc: '单局滑铲穿越悬挂闸门 5 次',  rarity: 'rare',   scope: 'run',   event: 'gateSlide',  target: 5 },
  { id: 'perfect5',   icon: '✧', name: '完美主义者', desc: '单局完美跳跃越过低障 5 次',  rarity: 'rare',   scope: 'run',   event: 'perfectJump', target: 5 },
